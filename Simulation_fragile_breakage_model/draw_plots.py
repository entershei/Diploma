...
def draw_relative_errors(file_end, experiments, parameters_for_plot_name):
    ...
    # For 3-3-cycles
    cycle_types = ["AAA-cycles", "AAB-cycles", "ABB-cycles", "BBB-cycles"]
    save_path = "plots/relative_error/" + experiments + file_end + "/"
    xs, errors = read_logs(
        "logs/relative_error/"
        + experiments
    ...
    for cycle_type in cycle_types + ["3-cycles"]:
        draw_error(
            xs,
            list(map(lambda error: error[cycle_type], errors)),
            "Relative error of number of "
...
def read_cycles_info_logs(f):
    ...
    return {
        ...
        "2-cycles": np.add(
            np.add(different_cycles["AA"], different_cycles["AB"]),
            different_cycles["BB"],
        ),
        "3-cycles": np.add(
            np.add(different_cycles["AAA"], different_cycles["AAB"]),
...
def draw_average_cycles(file_end, experiments):
    ...
    draw_number_of_cycles(
        cycles_info["1-cycles"],
        "Average number of 1-cycles depends of number of swaps",
        save_path + "1_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["A"],
        "Average number of A-cycles depends of number of swaps",
        save_path + "1_A_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["B"],
        "Average number of B-cycles depends of number of swaps",
        save_path + "1_B_cycles.png",
    )

    draw_number_of_cycles(
        cycles_info["2-cycles"],
        "Average number of 2-cycles depends of number of swaps",
        save_path + "2_cycles",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["AA"],
        "Average number of AA-cycles depends of number of swaps",
        save_path + "2_AA_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["AB"],
        "Average number of AB-cycles depends of number of swaps",
        save_path + "2_AB_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["BB"],
        "Average number of BB-cycles depends of number of swaps",
        save_path + "2_BB_cycles.png",
    )

    draw_number_of_cycles(
        cycles_info["3-cycles"],
        "Average number of 3-cycles depends of number of swaps",
        save_path + "3_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["AAA"],
        "Average number of AAA-cycles depends of number of swaps",
        save_path + "3_AAA_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["AAB"],
        "Average number of AAB-cycles depends of number of swaps",
        save_path + "3_AAB_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["ABB"],
        "Average number of ABB-cycles depends of number of swaps",
        save_path + "3_ABB_cycles.png",
    )
    draw_number_of_cycles(
        cycles_info["different_cycles"]["BBB"],
        "Average number of BBB-cycles depends of number of swaps",
        save_path + "3_BBB_cycles.png",
    )
...
def draw_average_with_analytical_cycles(file_end, experiments):
    ...
    xs, analytical_cycles = read_logs(
        "logs/analytical_cycles/n1000/c1/" + file_end + ".csv",
        cycle_types,
        cycle_types,
        "1-cycles",
        [],
    ...
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["1-cycles"]),
        list(map(lambda cycle: cycle["1-cycles"], analytical_cycles)),
        "Normalized number of 1-cycles depends of x",
        save_path + "1_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["A"]),
        list(map(lambda cycle: cycle["A-cycles"], analytical_cycles)),
        "Normalized number of A-cycles depends of x",
        save_path + "1_A_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["B"]),
        list(map(lambda cycle: cycle["B-cycles"], analytical_cycles)),
        "Normalized number of B-cycles depends of x",
        save_path + "1_B_cycles.png",
    )
    ...
    xs, analytical_cycles = read_logs(
        "logs/analytical_cycles/n1000/c2/" + file_end + ".csv",
        cycle_types,
        cycle_types,
        "2-cycles",
        [],
    ...
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["2-cycles"]),
        list(map(lambda cycle: cycle["2-cycles"], analytical_cycles)),
        "Normalized number of 2-cycles depends of x",
        save_path + "2_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["AA"]),
        list(map(lambda cycle: cycle["AA-cycles"], analytical_cycles)),
        "Normalized number of AA-cycles depends of x",
        save_path + "2_AA_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["AB"]),
        list(map(lambda cycle: cycle["AB-cycles"], analytical_cycles)),
        "Normalized number of AB-cycles depends of x",
        save_path + "2_AB_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["BB"]),
        list(map(lambda cycle: cycle["BB-cycles"], analytical_cycles)),
        "Normalized number of BB-cycles depends of x",
        save_path + "2_BB_cycles.png",
    )
    ...
    cycle_types = ["AAA-cycles", "AAB-cycles", "ABB-cycles", "BBB-cycles"]
    xs, analytical_cycles = read_logs(
        "logs/analytical_cycles/n1000/c3/" + file_end + ".csv",
        cycle_types,
        cycle_types,
        "3-cycles",
        [],
    ...
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["3-cycles"]),
        list(map(lambda cycle: cycle["3-cycles"], analytical_cycles)),
        "Normalized number of 3-cycles depends of x",
        save_path + "3_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["AAA"]),
        list(map(lambda cycle: cycle["AAA-cycles"], analytical_cycles)),
        "Normalized number of AAA-cycles depends of x",
        save_path + "3_AAA_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["AAB"]),
        list(map(lambda cycle: cycle["AAB-cycles"], analytical_cycles)),
        "Normalized number of AAB-cycles depends of x",
        save_path + "3_AAB_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["ABB"]),
        list(map(lambda cycle: cycle["ABB-cycles"], analytical_cycles)),
        "Normalized number of ABB-cycles depends of x",
        save_path + "3_ABB_cycles.png",
    )
    draw_two_number_of_cycles(
        xs,
        interesting_cycles_info(n, xs, cycles_info["different_cycles"]["BBB"]),
        list(map(lambda cycle: cycle["BBB-cycles"], analytical_cycles)),
        "Normalized number of BBB-cycles depends of x",
        save_path + "3_BBB_cycles.png",
    )
...
def main():
    ...
    different_parameters = [
        ("paa0_2_pbb0_6_alpha0_9", "n = 1000, paa = 0.2, p_bb = 0.6, α = 0.9"),
        ("paa0_4_pbb0_35_alpha0_7", "n = 1000, paa = 0.4, p_bb = 0.35, α = 0.7"),
        ("paa0_5_pbb0_5_alpha0_5", "n = 1000, paa = 0.5, p_bb = 0.5, α = 0.5"),
        ("paa0_5_pbb0_5_alpha0_8", "n = 1000, paa = 0.5, p_bb = 0.5, α = 0.8"),
        ("paa0_5_pbb0_45_alpha0_5", "n = 1000, paa = 0.5, p_bb = 0.45, α = 0.5"),
        ("paa0_45_pbb0_45_alpha0_5", "n = 1000, paa = 0.45, p_bb = 0.45, α = 0.5"),
    ]
